...
- Inside the main hero space, vertically center (`align-items: center;`) a single, prominent display heading that introduces the product inventory: "Design Skills for Agents".
...
- IF element == "heading": Apply property `font-family: "Geist Mono", monospace` AND `color: #000000` AND `font-weight: 700` AND `font-size: 24px` AND `letter-spacing: -0.02em`.
